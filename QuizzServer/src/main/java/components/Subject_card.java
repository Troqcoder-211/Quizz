...
public class Subject_card {
    ...
    public Subject_card(
        ...
        this.group_name.setText(subject.getSubjectName());
        this.group_id.setText(
                "GROUP_ID : " + (subject.getSubjectId() >= 10 ? subject.getSubjectId()
                        : "0" + subject.getSubjectId()));
        this.date_created.setText(subject.getCreateDate()
